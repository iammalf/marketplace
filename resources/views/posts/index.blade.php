<x-app-layout>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="{{ asset('storage/team/team-1-800x800.jpg') }}"
    ...
    <!-- SECCION DE TEXTO CARACTERISTICAS -->
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base text-indigo-600 font-black tracking-wide uppercase">Transactions</h2>
    ...
    <!-- SECCION DE LISTADO DE PRODUCTOS Y POSTS -->

    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
                <div>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam explicabo sit soluta error
                        nesciunt, provident nostrum quam veniam fugiat magnam aliquid, nihil quia labore, rerum enim
                        atque
                        praesentium et corporis!</p>
                </div>
                <div>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab distinctio, autem ipsum ipsa iste nam
                        odio fuga laudantium nemo explicabo earum minus incidunt repellendus consectetur placeat
                        voluptatum obcaecati harum consequatur.</p>
                </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="p-4">
                                            <a href="{{ route('posts.show', $post) }}">
                                                <h1 class="font-bold text-base text-lg text-gray-900 mb-1">
                                                    {{ $post->name }}</h1>
                                            </a>
                                            <div class="mt-6 flex justify-between">
                                                <div>
                                                    <h3 class="font-bold text-red-400">$35.00</h3>
                                                    <p>Mejor Vendido</p>
                                                </div>
                                                <div>
                                                    <button
                                                        class="border-2 border-gray-200 mt-2 hover:bg-gray-400 text-gray-700 hover:text-white px-2 py-2 shadow-xl focus:outline-none">
                                                        Ver Detalle
                                                    </button>
                                                </div>
                                            </div>
